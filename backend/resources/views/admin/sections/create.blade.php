@extends('layouts.app')
@section('title', 'Nova Secao')
@section('content')
<div class="p-6">
    <div class="flex items-center justify-between mb-4">
        <h1 class="text-xl font-semibold text-gray-700">Nova Secao</h1>
    ...
    <form action="{{ route('admin.sections.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        ...
        <div class="mt-4">
            ...
            <textarea name="content" id="content" rows="6" required
                      class="wysiwyg w-full border rounded-md px-3 py-2 text-sm">{{ old('content') }}</textarea>
        </div>
        <div class="mt-4">
